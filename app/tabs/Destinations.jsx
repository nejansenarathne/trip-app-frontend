    ...
    <ScrollView showsVerticalScrollIndicator={false} style={{ backgroundColor: "#FFFFFF" }}>
      <View style={styles.container}>
          ...
          <View style={{ flexDirection: "row", gap: 10 }}>
            ...
            >
              {user?.profile_picture ? (
                ...
                <Image source={require("../../assets/images/ProfPic.png")} style={{ width: 38, height: 38, borderRadius: 19 }} />
              )}
            </TouchableOpacity>
          </View>
        </View>
        ...
        <TouchableOpacity
          ...
          onPress={() => goToSearch("")}
        >
          <Ionicons name="search-outline" size={20} color="#064E3B" />
        ...
        {featuredDestination ? (
          ...
          <View style={[styles.featureWrap, { height: 170, backgroundColor: '#F3F4F6', borderRadius: 24 }]} />
        )}
...
const styles = StyleSheet.create({
  container: {
    ...
    paddingTop: 30, // Better spacing for modern headers
    paddingBottom: 20,
  },
  ...
  title: {
    fontSize: 32,
    fontWeight: "900", // Heavy weight for MyTrips theme
    color: "#064E3B", // Emerald Dark Green
    letterSpacing: -1,
  },
  ...
  profileBtn: {
    ...
    borderWidth: 2,
    borderColor: "#064E3B", // Emerald border
    overflow: 'hidden',
  },
  ...
  searchBar: {
    ...
    paddingVertical: 14,
    borderRadius: 16, // More "boxy-modern" than pill-shaped
    borderWidth: 1.5,
    borderColor: "#E5E7EB",
  },
